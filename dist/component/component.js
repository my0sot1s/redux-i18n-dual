...
var I18n = function (_React$Component) {
  ...
  function I18n(props) {
    ...
    _this.sty = _this.sty.bind(_this);
    return _this;
  }
  ...
  _createClass(I18n, [{
    ...
    key: 'sty',
    value: function sty(textKey, params, comment) {
      var styles = this.props.useReducer ? this.props.styles_reducer : this.props.styles;
      var themeMessages = styles[this.props.theme];
